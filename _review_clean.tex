...
%DIF ADD _v7.tex                                   Thu Aug 27 15:21:40 2026
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}l S[table-format=1.5] S[table-format=1.5] S[table-format=1.5] S[table-format=1.5] S[table-format=1.5] S[table-format=1.5] S[table-format=1.5] S[table-format=1.5] S[table-format=1.5]@{}}
\toprule
...
The work in Ferreira \emph{et al.}~\cite{Ferreira2020} reported the lowest median LBP Distance value of $0.17$. In contrast, our proposed method achieved a LBP Distance median of $0.150075$, a reduction of approximately $12.4\%$, indicating that our method generates textures with substantially higher fidelity to the original images at the level of local binary patterns.

Overall, our proposed context-oriented synthesis approach obtains better quantitative performance across all three measures when compared to the sketch-based method of Ferreira \emph{et al.}~\cite{Ferreira2020}. The improvement is most pronounced in MSE ($\approx 16.7\%$ reduction: from $4712.1$ to $3926.2$) and LBP Distance ($\approx 12.4\%$ reduction: from $0.17$ to $0.15$), which together suggest meaningful gains in pixel-level accuracy and textural fidelity. The DSSIM difference is marginal ($\approx 0.2\%$), and we do not claim statistical significance for it; both methods are structurally comparable by this measure, and the primary advantages of the proposed approach are better captured by MSE and LBP Distance.
