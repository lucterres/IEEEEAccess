...
%DIF DEL _v6_base_419c68f.tex   Mon Apr 27 12:16:55 2026
%DIF ADD _v6.tex                Fri Apr 24 18:21:24 2026
...
%DIFDELCMD < %%%
%DIF < LUCIANO: precisas mostrar o que estes grupos representam e como são formados  - Ferreira propos 5 grupos e nós 4 precisas explicar porque da diferença
%DIFDELCMD < 
...
%DIFDELCMD < %%%
% The deleted Sketch Generation and GAN-Based Image Synthesis substructure
% was simplified to avoid invalid latexdiff wrappers around list environments.
\DIFdelbegin \DIFdel{Their approach consists of two main stages, including sketch generation and GAN-based image synthesis. }\DIFdelend
\DIFaddbegin \DIFadd{The }\DIFaddend generator network takes \DIFaddbegin \DIFadd{a }\DIFaddend sketch as input and learns to produce realistic seismic images
...
\cite{Ferreira2020} }\hskip0pt%DIFAUXCMD
}\DIFaddend achieved a median MSE of 4712.1 with their best-performing \DIFdelbegin \DIFdel{sketch type, our }\DIFdelend \DIFaddbegin \DIFadd{configuration. Our }\DIFaddend context-oriented approach \DIFdelbegin \DIFdel{yielded }\DIFdelend \DIFaddbegin \DIFadd{achieved }\DIFaddend a median MSE of \DIFdelbegin \DIFdel{542.87. This result is approximately 8.7 times lower}\DIFdelend \DIFaddbegin \DIFadd{2037.88}\DIFaddend , demonstrating a substantial improvement in the pixel-wise correspondence between the synthetic and original images.
...
In Ferreira \emph{et al.}~\cite{Ferreira2020}, the best median DSSIM achieved was 0.39\DIFdelbegin \DIFdel{(with Sketch Type D)}\DIFdelend . Our method \DIFdelbegin \DIFdel{surpassed this benchmark, with Group 2 achieving }\DIFdelend \DIFaddbegin \DIFadd{achieved }\DIFaddend a median DSSIM of \DIFdelbegin \DIFdel{0.2424. This result is significantly better, as }\DIFdelend \DIFaddbegin \DIFadd{0.1537. Recall that }\DIFaddend a DSSIM value above 0.25 can be interpreted as \DIFdelbegin \DIFdel{"}\DIFdelend \DIFaddbegin \DIFadd{``}\DIFaddend low perceptual similarity.\DIFdelbegin \DIFdel{" While the baseline result falls into this range, our Group 2 median is just below this threshold. Furthermore, Group 2 was not only the top performer in structural quality but also the most consistent, showing the smallest Interquartile Range (IQR) of 0.0080.
