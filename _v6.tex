...
The sketch-based baseline method~\cite{Ferreira2020} achieved a median MSE of 4712.1 with their best-performing configuration. Our context-oriented approach achieved a median MSE of 2037.88, demonstrating a substantial improvement in the pixel-wise correspondence between the synthetic and original images.

In Ferreira \emph{et al.}~\cite{Ferreira2020}, the best median DSSIM achieved was 0.39. Our method achieved a median DSSIM of 0.1537. Recall that a DSSIM value above 0.25 can be interpreted as ``low perceptual similarity.''

The baseline work in Ferreira \emph{et al.}~\cite{Ferreira2020} reported a lowest median LBP Distance of 0.17. In contrast, our proposed method achieved a LBP Distance median of 0.0283, indicating that our method generated textures with substantially higher fidelity to the original images.
