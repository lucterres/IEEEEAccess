...
Texture synthesis is a technique used in computer graphics and image processing to generate new textures that are visually similar to a given sample texture. Nonparametric texture synthesis methods~\cite{Efros1999} create new images by sampling and recombining patches from example textures, ensuring that the statistical properties of the generated texture match those of the original.
