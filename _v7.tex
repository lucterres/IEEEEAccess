...
The overall classification accuracy of $63.7\%$ ($n = 270$) is statistically significant above chance (one-sided exact binomial test: $k = 172$, $p = 0.000004$; one-sided 95\% CI: $p > 0.586$). This indicates that the synthetic images are sufficiently realistic to challenge expert discrimination, but remain distinguishable from real images. The confusion between classes is near-symmetric: real images were misclassified as synthetic in 37.0\% of trials, and synthetic images as real in 35.6\%, suggesting that neither class was consistently easier to identify.
