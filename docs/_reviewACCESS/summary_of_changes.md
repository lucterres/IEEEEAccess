...
- R2.3 Expanded baseline comparison (GAN/diffusion) — **DONE** (contextual comparison added: Related Work expanded; new subsubsection + Table~\ref{tab:comparison_overview} in Sec IV; pix2pix2017 bibitem added; Ferreira/Choi/Henriques/Wang organized into comparative landscape)
...
| 7  | R2.3        | **Sec. IV — new subsubsection**                    | New subsubsection *Contextual Comparison with GAN-based and Diffusion-based Methods* added: structured discussion of Henriques et al. (VAE+CNF, non-public synthetic dataset), Choi et al. (pix2pix GAN~\cite{Choi2021} + conditional diffusion~\cite{Choi2025}, correctly attributed), Wang et al. (SeismoGen GAN); explicit statement that only Ferreira et al. enables direct numerical comparison | 540–550          |
| 8  | R2.3        | **Sec. IV — Table**                                | New **Table (comparison_overview)** added: five-method comparison table (model type, target task, direct comparison feasibility); Choi row cites both~\cite{Choi2021,Choi2025} and reads `Cond. pix2pix GAN + Diffusion`; Wang target task labeled `Waveform aug.` for parallelism                                                                                                                                                                                                                                             | 552–570          |
